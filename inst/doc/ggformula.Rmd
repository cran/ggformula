...
```{r, factors, fig.keep = 1, fig.width = 5}
...
Improved map functionality is coming in `ggplot2` version 2.3.  For now,
basic maps can be created using `gf_polygon()`.
...
to day and displaying the resulting pdf.
