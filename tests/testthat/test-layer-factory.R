...
test_that("gf_crossbar(), gf_errorbar(), gf_pointrange()", {
...
test_that("gf_dens() and gf_density", {
  wrapped_expect_doppelganger(
    "gf_dens1",
...
test_that("gf_empty(), gf_blank(), and gf_frame()", {
  wrapped_expect_doppelganger(
    "gf_empty1",
    gf_empty() |>
      gf_labs(title = "empty")
...
test_that("gf_histogram() and gf_dhistogram", {
  wrapped_expect_doppelganger(
    "gf_histogram1",
  ...
  wrapped_expect_doppelganger(
    "gf_dhistogramh2",
    gf_dhistogram(
      bill_length_mm ~ after_stat(ndensity),
      data = penguins2,
      bins = 30
    )
  )
...
test_that("gf_label() and gf_text()", {
  wrapped_expect_doppelganger(
    "gf_label1",
...
test_that("gf_linerange() and gf_pointrange()", {
  wrapped_expect_doppelganger(
    "gf_linerange1",
    gf_linerange(
      low_temp + high_temp ~ date,
...
test_that("gf_qq(), gf_qqstep(), gf_qqline()", {
  wrapped_expect_doppelganger(
    "gf_qq1",
